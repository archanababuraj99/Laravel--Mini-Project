...
{{ csrf_field() }}
  ...
  <div class="card-body">
   <strong> <h5 class="card-title">Booking Confirmed</h5></strong>
...
<tr>
 ...
 <tr>
                ...
                <td><?php if($st1->Status=='1'){?><h4 style="color:green;">Booking Approved</h4><?php }else if($st1->Status=='2'){?><h4 style="color:red;">Booking Rejected</h4><?php }else { ?><h4 style="color:blue;">Booking Pending</h4><?php } ?></td>
